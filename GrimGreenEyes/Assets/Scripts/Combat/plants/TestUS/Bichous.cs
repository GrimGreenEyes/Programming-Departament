        ...
        switch (actualState)
        {
            ...
            case EntityState.ATTACKING:
                ...
                if(name == "Orlaw" && moveAndAttack && skills[0].coolDown == 0)
                {
                    ...
                    msg.GetComponent<TextMeshProUGUI>().text = "Incremento de da�o";
...
;               options[4] = pesoVerpendex;
    ...
    */
    ...
    public float CalcRentable(Plants plant, Bichous insect)
    {
        ...
        Debug.Log("En un posible combate " + plant.name + " me quitar�a " + posibleInsectDamage + " puntos de vida");
        int posiblePlantDamage = insect.mainAttack.DamageCalculator(plant, insect);
        Debug.Log("En un posible combate le quitar�a " + posiblePlantDamage + " puntos de vida a " + plant.name);
